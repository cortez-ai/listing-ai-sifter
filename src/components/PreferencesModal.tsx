        ...
        <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="outline"
                    className="border-teal-600 text-teal-500 hover:bg-transparent hover:text-white"
                  >
                    Cancel
                  </Button>
                </div>
          ...
          <div className="flex gap-2">
            <Button
              ...
              variant="outline"
              size="sm"
              className="flex-1 border-teal-600 text-teal-500 hover:bg-teal-600 hover:text-white"
            >
                  ...
                  >
                    ...
                    <div className="flex gap-1">
                      <Button
                        ...
                        size="sm"
                        variant="ghost"
                        className="h-6 w-6 p-0 text-gray-400 hover:text-teal-500"
                      >
